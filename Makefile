...
# Author  : jhlee
# email   : @esss.se
# Date    : generated by 2017Nov22-1410-40CET
# version : 0.0.0 
#
# template file is generated by prepare_module.bash with e9f5ea0b9074bd24e49826c8c56633013ee9b5e1
#
...
epics:
	...
	@echo "INSTALL_LOCATION=$(M_SNCSEQ)"         > $(TOP)/$(EPICS_MODULE_SRC_PATH)/configure/CONFIG_SITE
	@echo "RE2C = re2c"                         >> $(TOP)/$(EPICS_MODULE_SRC_PATH)/configure/CONFIG_SITE
